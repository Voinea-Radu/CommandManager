...
![Version-Velocity](https://img.shields.io/badge/Version%20Velocity-2.0.5-red.svg)
...
dependencies {
    ...
    implementation "dev.lightdream:command-manager-velocity:2.0.5"
}
```
  </details>
...
dependencies {
    ...
    implementation "com.github.L1ghtDream:command-manager-velocity:2.0.5"
}
```
  </details>
</blockquote></details>
