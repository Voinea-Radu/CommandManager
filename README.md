...
![Version](https://img.shields.io/badge/Version-6.1.3-red.svg)
...
dependencies {
    implementation "dev.lightdream:command-manager:6.1.3"
    implementation "com.github.L1ghtDream:command-manager:6.1.3"
}
```
