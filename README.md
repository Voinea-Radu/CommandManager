...
![Version](https://img.shields.io/badge/Version-4.2.16-red.svg)
...
dependencies {
    implementation "dev.lightdream:command-manager:4.2.16"
    implementation "com.github.L1ghtDream:command-manager:4.2.16"
}
```
