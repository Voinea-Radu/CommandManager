...
![Version](https://img.shields.io/badge/Version-4.4.14-red.svg)
...
dependencies {
    implementation "dev.lightdream:command-manager:4.4.14"
    implementation "com.github.L1ghtDream:command-manager:4.4.14"
}
```
