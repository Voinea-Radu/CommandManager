...
![Version](https://img.shields.io/badge/Version-6.1.2-red.svg)
...
dependencies {
    implementation "dev.lightdream:command-manager:6.1.2"
    implementation "com.github.L1ghtDream:command-manager:6.1.2"
}
```
